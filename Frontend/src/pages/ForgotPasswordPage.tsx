...
const ForgotPasswordPage: React.FC = () => {
  ...
  const handleSendEmail = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        alert(data.message);
        // Navigate to reset page with email as query param
      ...
      <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-8 sm:p-10">
        ...
        <div className="text-center mb-8">
          <div className="flex flex-col items-center mb-6">
            ...
            />
            <h1 className="text-2xl font-bold text-[#21589C]">
        ...
        <div className="text-center mt-6">
          <button
            className="text-sm font-medium text-[#21589C] hover:text-[#21589C]/80"
